...
function createCreationTemplate(point, allOffers, pointDestination, allDestination) {
                ...
                <section class="event__section  event__section--destination">
                  ...
                  <div class="event__photos-container">
                    <div class="event__photos-tape">
                      ${pictures.length !== 0 ? pictures.map((picture) => `<img class="event__photo" src="${picture.src}" alt="${picture.description}"></img>`).join('') : ''}
                    </div>
                  </div>
                </section>
            </section>
...
export default class Creation extends AbstractView {
  ...
  get template() {
    return createCreationTemplate(this.#point, this.#allOffers, this.#pointDestination, this.#allDestination);
  }
}
